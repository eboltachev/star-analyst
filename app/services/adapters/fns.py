...
class FnsRegistryAdapter(BaseSourceAdapter):
    def _normalize(self, item: dict, query: dict) -> EvidenceRecord:
        ...
        return EvidenceRecord(
            ...
            meta={"matched_by": query.get("inn"), "runtime_mode": self.source_config.get("mode", "fixture")},
        )
    ...
    def search(self, query: dict) -> list[EvidenceRecord]:
        if self.source_config.get("mode") == "http":
            ...
            fixture = Path("tests/fixtures/fns_registry.json")
